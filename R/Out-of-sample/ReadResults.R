...
##  vs the 2D P-spline (cohort), LC (period) and 
##  APC (period) models 
##  
...
colnames(RMSE_table) <- colnames(MAE_table) <- 
  colnames(MAPE_table) <- c(rep(c("CSTAD","2Dsmo","LC","APC"),2),"horiz")
